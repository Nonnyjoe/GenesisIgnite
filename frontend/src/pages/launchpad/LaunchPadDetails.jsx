            ...
            >
              <div className="w-[75%]">
                ...
                <div className="flex justify-between flex-row">
                  <p className={`${styles.launchpadsymbol} font-pop`}>
                    {LaunchPadData.symbol}
                  </p>
                  <p className={`${launchStatusClassName} font-pop`}>
                    {Lstatus()}
                  </p>
                </div>
              </div>
          ...
          <div className={styles.leftside}>
            ...
            <form onSubmit={handleSubmit}>
              <div className={`${styles.participate} mb-6`}>
                <h5 className={`${styles.participationheader} font-pop`}>
                  PARTICIPATE
                </h5>
                <p className={`${styles.participationparagraph} text-base`}>
                  {" "}
                  <span className="uppercase">Requirement : </span> To
                  participate, you need GIT Token{" "}
                </p>
                ...
                <div className={`${styles.pl2} mt-9 font-pop w-[100%]`}>
                  ...
                  <div className="flex flex-row gap-5 ml-[-1rem]">
                    {epochTime2() > LaunchPadDeadline ? (
                      ...
                      >
                        {loadingWithdrawWaitData || withdrawalLoading
                          ? ".....Processing"
                          : "Withdraw Reward"}
                      </button>
                    ) : (
